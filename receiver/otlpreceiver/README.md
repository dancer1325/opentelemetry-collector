...
* == receive data | [OTLP](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/protocol/otlp.md) format 
  * -- via --
    * gRPC, OR
...
### [security best practices](https://opentelemetry.io/docs/security/config-best-practices/#protect-against-denial-of-service-attacks)

## Advanced Configuration

* helper files / provide ADDITIONAL capabilities
  - [gRPC settings](../../config/configgrpc/README.md)
...
* TODO: The OTLP receiver can receive trace export calls via HTTP/JSON in addition to gRPC
The HTTP/JSON address is the same as gRPC as the protocol is recognized and processed accordingly
Note the serialization format needs to be [OTLP JSON](https://opentelemetry.io/docs/specs/otlp/#json-protobuf-encoding).
