...
| Name                   | Type                                                                  | Default      | Docs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|------------------------|-----------------------------------------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| endpoint               | string                                                                | localhost:4317 | address \| this network connection <br/> \| TCP and UDP networks, address' form: "host:port" <br/> &nbsp;&nbsp; host == literal IP address, <br/> &nbsp;&nbsp; &nbsp;&nbsp; if the host == literal IPv6 address -> enclose it \| square brackets -- _Example:_ "[2001:db8::1]:80" OR "[fe80::1%zone]:80" -- <br/> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; zone == literal IPv6 address' scope / defined \| RFC 4007 <br/> &nbsp;&nbsp; OR host name / can be resolved -- to -- IP addresses <br/> &nbsp;&nbsp; port == literal port number OR service name <br/> &nbsp;&nbsp; [syntax](https://github.com/grpc/grpc/blob/master/doc/naming.md) |
...
| Name                  | Type                                                      | Default      | Docs                                                                                                                         |
|-----------------------|-----------------------------------------------------------|--------------|------------------------------------------------------------------------------------------------------------------------------|
| endpoint              | string                                                    | localhost:4318 | listening address -- for the -- server                                                                                       |
