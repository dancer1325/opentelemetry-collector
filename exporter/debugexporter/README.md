...
* outputs telemetry data | console
* uses
  * debugging
    * _Example of how to use:_ [here](https://opentelemetry.io/docs/collector/troubleshooting/#local-exporters)

## Getting Started

* [configuration](config.md)

- `verbosity` the verbosity of the debug exporter: `basic`, `normal` or `detailed`.
